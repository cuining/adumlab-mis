...
interface BasicProps {
  loading: boolean;
  dispatch: Dispatch;
  lantern: BasicProfileDataType;
}
interface BasicState {
  visible: boolean;
}

class Lantern extends Component<BasicProps, BasicState> {
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'lantern/fetchBasic',
    });
  }

  render() {
    const { lantern, loading } = this.props;
    const { basicGoods, basicProgress } = lantern;
...
export default connect(
  ({
    ...
    lantern,
    loading: loading.effects['lantern/fetchBasic'],
  }),
)(Lantern);
