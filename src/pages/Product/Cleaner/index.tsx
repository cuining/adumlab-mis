...
interface BasicProps {
  loading: boolean;
  dispatch: Dispatch;
  cleaner: BasicProfileDataType;
}
interface BasicState {
  visible: boolean;
}

class CLeaner extends Component<BasicProps, BasicState> {
  componentDidMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'cleaner/fetchBasic',
    });
  }

  render() {
    const { cleaner, loading } = this.props;
    const { basicGoods, basicProgress } = cleaner;
...
export default connect(
  ({
    ...
    cleaner,
    loading: loading.effects['cleaner/fetchBasic'],
  }),
)(CLeaner);
