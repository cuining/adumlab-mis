export default {
  ...
  'pages.welcome.alertMessage': '美好的一天开始了。',
  'pages.admin.subPage.title': ' 这个页面只有 admin 权限才能查看',
  'pages.admin.subPage.alertMessage': 'umi ui 现已发布，欢迎使用 npm run ui 启动体验。',
  'pages.searchTable.createForm.newAccount': '新建账号',
  ...
  'pages.searchTable.requireTitle': '文章标题为必填项',
  'pages.searchTable.requireContent': '文章内容为必填项',
  ...
  'pages.searchTable.password': '用户名',
  ...
  'pages.searchTable.createForm.newArticle': '新建文章',
};
